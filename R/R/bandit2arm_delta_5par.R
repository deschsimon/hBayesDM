#' @templateVar MODEL_FUNCTION bandit2arm_delta_5par
...
#' @templateVar MODEL_NAME Rescorla-Wagner (Delta) Model (5 parameters)
#' @templateVar MODEL_CODE delta_ext
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "choice", "outcome"
#' @templateVar PARAMETERS \code{Arew} (reward learning rate), \code{Apun} (punishment learning rate), \code{tau} (inverse temperature), \code{R} (reward sensitivity), \code{P} (punishment sensitivity)
...
bandit2arm_delta_5par <- hBayesDM_model(
  task_name       = "bandit2arm",
  model_name      = "delta_5par",
  model_type      = "",
