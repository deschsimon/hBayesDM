#' @templateVar MODEL_FUNCTION bandit2arm_delta_3par
...
#' @templateVar MODEL_NAME Rescorla-Wagner (Delta) Model (3 parameters)
#' @templateVar MODEL_CODE delta_ext
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "choice", "outcome"
#' @templateVar PARAMETERS \code{Arew} (reward learning rate), \code{Apun} (punishment learning rate), \code{tau} (inverse temperature)
...
bandit2arm_delta_3par <- hBayesDM_model(
  task_name       = "bandit2arm",
  model_name      = "delta_3par",
  model_type      = "",
